                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Pengelola </span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="caption pro-sl-hd">
                                            <span class="caption-subject"><b>Form Data Pengelola</b></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                                ...
                                                                <div class="form-group-inner">
                                                                    <div class="row">
                                                                        <div
                                                                            ...
                                                                            <label
                                                                                class="login2 pull-right pull-right-pro">Nama Lengkap</label>
                                                                        </div>
                                                                        <div
                        ...
                        <div class="product-sales-chart">
                            <div class="portlet-title">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="caption pro-sl-hd">
                                            <span class="caption-subject"><b>Data Pengelola</b></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <table id="table" data-toggle="table" data-pagination="true"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-field="namalengkap" data-editable="false">Nama
                                                                Lengkap</th>
                                                            <th data-field="jabatan" data-editable="false">Jabatan
                                                            </th>
                                                            <th data-field="username" data-editable="false">Username</th>
                                                            <th data-field="password">Password</th>
                                                            <th data-field="telepon" data-editable="false">Nomor Telepon</th>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>Admin</td>
                                                            <td>sariah123</td>
                                                            <td>asdw333qe@#weeaaa!qw!!$%$fdsfxcvq124</td>
                                                            <td>082176761122</td>
