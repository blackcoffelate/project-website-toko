                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Persediaan </span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="caption pro-sl-hd">
                                            <span class="caption-subject"><b>Form Data Persediaan Masuk</b></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                                ...
                                                                <div class="form-group-inner">
                                                                    <div class="row">
                                                                        <div
                                                                            ...
                                                                            <label
                                                                                class="login2 pull-right pull-right-pro">Nama Barang</label>
                                                                        </div>
                                                                        <div
                                                                ...
                                                                <div class="form-group-inner">
                                                                    <div class="row">
                                                                        <div
                                                                            class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                            <label
                                                                                class="login2 pull-right pull-right-pro">Jenis Barang</label>
                                                                        </div>
                                                                        <div
                                                                            class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                            <input type="text" class="form-control" />
                                                                ...
                                                                <div class="form-group-inner">
                                                                    <div class="row">
                                                                        <div
                                                                            class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                            <label
                                                                                class="login2 pull-right pull-right-pro">Harga Barang</label>
                                                                        </div>
                                                                        <div
                                                                            class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                            <input type="text" class="form-control" />
                                                                ...
                                                                <div class="form-group-inner">
                                                                    <div class="row">
                                                                        <div
                                                                            class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                            <label
                                                                                class="login2 pull-right pull-right-pro">Total Barang Masuk</label>
                                                                        </div>
                                                                        <div
                                                                            class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                            <input type="text" class="form-control" />
                        ...
                        <div class="product-sales-chart">
                            <div class="portlet-title">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="caption pro-sl-hd">
                                            <span class="caption-subject"><b>Data Persediaan Masuk</b></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <table id="table" data-toggle="table" data-pagination="true"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-field="namabarang" data-editable="false">Nama
                                                                Barang</th>
                                                            <th data-field="jenis" data-editable="false">Jenis Barang
                                                            </th>
